...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_tur to login script."
...
# the current dir:
if   test x${GTLANG_tur} = x ; then
	echo "WARNING: The variable \${GTLANG_tur} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_tur} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_tur} has the value:"
	echo "  ${GTLANG_tur}"
