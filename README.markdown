...
This directory contains source files for the Turkish language morphology
...
-   <http://giellatekno.uit.no/turdoc/index.html>
-   <https://giellalt.uit.no/tools/docu-tur-manual.html>
...
The Turkish language sources can be acquired using [giella SVN
